function [x,n,code,l,X,a,C,L,nus,r,J,A]=sqpsq(fun,con,x0,epsR,epsC,maxIter,params,nu0,mu)
%SQPSQ Sequential quadratic programming for least-squares problems.
%
%[x,n,code,lambda,X,alphas,C,L,nu,r,J,A]=sqpsq(fun,con,x0,epsR,epsC,maxIter,params,nu0,mu)
